...
class SkyFi():
    ...
    def __init__(self, name, unit_of_measurement, host, password):
        ...
        self._zones_numbers = {1: 8, 2: 7, 4: 6, 8: 5, 16: 4, 32: 3, 64: 2, 128: 1}
        self._zone_names = {1:"Theatre", 2:"Gym", 3:"Family", 4:"Beds", 5:"5", 6:"6", 7:"7", 8:"8"}
    ...
    def set_props(self, data):
        ...
        self._zones = [self._zone_names[i] for i in [self._zones_numbers[i] for i in find_the_base_numbers(target_number=int(plist['zone']), numbers = list(self._zones_numbers), results = [])]]
    ...
    def doQuery(self, payload):
        ...
        while retry_count > 0:
            ...
            try:
                ...
                if retry_count == 0:
                    print("Query: {} failed {}: {}".format(self._name, payload, ex))
                # conn.close()
                time.sleep(2)
        return data
